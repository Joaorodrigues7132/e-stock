...
export default function ModalClasseDelete({open, onChangeOpen, id}) {
            ...
            <BackModal>
                <Modal>
                    ...
                    <ModalFields>     
                        ...
                        <Button spaced="15px" fill="rgba(33, 217, 82, 0.8)" size="100%" onClick={() => deleteClasse(id)}>Deletar</Button>
                    </ModalFields>
                </Modal>   
            </BackModal> 
        )
