            ...
            <BackModal>
                <Modal>
                    ...
                    <ModalFields>
                        ...
                        <Button spaced="15px" fill="#998543" size="100%" onClick={() => updateEstoque(id)}>Editar</Button>
                        <Button spaced="15px" fill="#998543" size="100%" onClick={() => getEstoque(id)}>Pegar dados atuais</Button>
                    </ModalFields>
                </Modal>   
            </BackModal> 
        )
